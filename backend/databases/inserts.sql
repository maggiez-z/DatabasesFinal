...
--  SELECT d.dish_id, d.dish_name, d.ingredients, d.calories, d.price FROM has_dish h, Dish d WHERE h.menu_id = 6 AND h.dish_id = d.dish_id;
 ...
 SELECT u.user_name, a.answer_id, a.answer, a.time_answered FROM has_answer h, Give_answer a, User u WHERE h.question_id = 1 AND h.answer_id = a.answer_id AND a.user_id = u.user_id;